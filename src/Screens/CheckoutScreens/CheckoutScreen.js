...
const CheckoutScreen = ({route}) => {
  ...
  const options = [
    { 
      ...
      onClick : ()=> navigation.navigate('CardPayment' , {amount :  total})
    },
    { 
      method: 'UPI', 
      image : 'Upi',
...
<View style = {styles.box}>
      ...
      <View style={styles.addressView}>
        ...
        <Text
          style={[
            styles.title,
            {marginTop: verticalScale(10), fontSize: fontSize.regular, color: '#636363'},
          ]}>
          {selectedAddress ? selectedAddress : 'Please Enter Address'}
        </Text>
